  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15">
          <button className="shadow-lg hover:shadow-slate-300 mx-auto bg-no-repeat bg-auto" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}}>
