  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15">
          <div className="shadow-lg hover:shadow-slate-300 bg-no-repeat bg-auto" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
              
            <h1 className="justify-center">Crowd Funding</h1>
