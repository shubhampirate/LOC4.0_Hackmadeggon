  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15">
          <button className="shadow-lg hover:shadow-slate-300 bg-no-repeat bg-auto height-100" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
