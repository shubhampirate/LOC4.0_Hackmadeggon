  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15">
          <button className="shadow-lg hover:shadow-slate-300 mx-auto" style={{backgroundImage: "url(https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.sermoncentral.com%2Fchurch-media-preaching-sermons%2Fmotion-backgrounds-about-poverty&psig=AOvVaw1GFusWeazA5da3a1fjuCWV&ust=1647161231204000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCJCxgfmXwPYCFQAAAAAdAAAAABAE)"}}>
