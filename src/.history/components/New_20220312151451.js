  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15 ">
          <div className="h-15px shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
