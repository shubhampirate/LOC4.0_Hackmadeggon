  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15">
          <button className="shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover height-100" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
              
            <h1>Crowd Funding</h1>
              <p className="h-15px">Donors and Companies in nearly every country in the world. 
