  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="pt-12 bg-slate-400 ">
        
          <div className="py-15 ">
          <button className="h-15px shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
           <p>   
            <h1>Crowd Funding</h1>
              <h2>Donors and Companies in nearly every country in the world. </h2>
                <h2>This crowdfunding platform helps organizations access the tools, training, and support they need to be more effective and help their communities.</h2>
<h2>                 This is a secure and trusted platform to raise money.</h2>
</p>
          </button>
