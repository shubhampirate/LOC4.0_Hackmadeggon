        ...
        <div className='w-full h-[550px] hidden md:block'>
            ...
            <div className='p-4 flex flex-col justify-around'>
                <form>
                    ...
                    <div>
                    <Link to="/bookingslot">     <h1 className='text-5xl italic text-center'>Bookingslot</h1Fundraisers</h1>  <p className="text-3xl">Donors and Companies in nearly every country in the world. 
                This crowdfunding platform helps organizations access the tools, training, and support they need to be more effective and help their communities.
