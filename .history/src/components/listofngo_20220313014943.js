    ...
    <div>
      ...
      <div className="flex "> 
        ...
        <div className='hidden sm:block'>
            ...
            <div className="text-left text-3xl pl-10"><Link to="/payment">1. Akshara Centre </Link></div>
            <div className="text-left text-3xl pl-10"><Link to="/payment"> 2.  ALERT-INDIA Association for Leprosy education, Rehabilitation & Treatment India </Link></div>
            <div className="text-left text-3xl pl-10"><Link to="/payment">  3.  Annamrita-ISKCON Food Relief Foundation</Link></div>
            <div className="text-left text-3xl pl-10"><Link to="/payment"> 4.  Antarang Foundation  </Link></div>
            <div className="text-left text-3xl pl-10"><Link to="/payment"> 5.  Ashadeep Association </Link></div>

                    </div>

        <div className=' flex flex-col justify-between'>
          <h1 className='text-5xl text-center'>SERVICES </h1>
          <div className="text-3xl justify-self-auto">Education</div>
          <div className="text-3xl  justify-self-auto">Health</div>
          <div className="text-3xl  justify-self-auto">Children</div>
          <div className="text-3xl  justify-self-auto">Education</div>
          <div className="text-3xl  justify-self-auto">Children</div>
