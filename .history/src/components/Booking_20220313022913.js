  ...
  return (
    <div>
      ...
      <div className="bg-white relative w-full height-7xl flex">
       ...
       <button className="h-72 w-fit p-20 m-2  text-8xl text-indigo-100 transition-colors duration-150 bg-orange-400 rounded-lg focus:shadow-outline hover:bg-cyan-500"> WorkShops</button>
                    </div>
        </div>
