...
function Home () {
  return (
    ...
    <div className="flex ">
     ...
     <div className="pl-5">
     <button className=" text-2xl w-28 py-2 pl-2 mt-8 bg-black hover:bg-gray-600 hover:text-white relative text-white rounded-lg text-opacity-10"><Link to="/signin">User SignUp </Link></button>
     </div><button className=" pl-10 pr-10 text-3xl"><Link to="/signup">Ngo Signup</Link></button>
     </div>
     </div>
