  ...
  return (
    <div>
        ...
        <div  className="flex ">
          ...
          <button className="h-full shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover " style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
