    ...
    <div>
      ...
      <div className="flex "> 
        ...
        <div className='hidden sm:block'>
            ...
            <div className="textleftr text-3xl pl-10"><Link to="/payment">  3.  Annamrita-ISKCON Food Relief Foundation</Link></div>
            <div className="text-left text-3xl pl-10"><Link to="/payment"> 4.  Antarang Foundation  </Link></div>
            <div className="text-clefttext-3xl pl-10"><Link to="/payment"> 5.  Ashadeep Association </Link></div>
