...
function Home () {
  return (
    ...
    <div className="flex justify-center">
     ...
     <div className="bg-no-repeat w-full h-full" style={{backgroundImage:"url(https://ak.picdn.net/offset/photos/598dbbd017fb156e48068e52/medium/offset_601742.jpg)"}}>for better humanity purposes</div>
     </div>
  )
}
