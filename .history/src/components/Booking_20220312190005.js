    ...
    <div>
      ...
      <div className="flex justify-around">
        <div className="flex justify-center pt-10 text-5xl ">
          <button className="pr-20 shadow-lg box-order text-right h-32 w-80 ">Seminars</button>
        </div>
        <div className="flex justify-center pt-10 text-5xl box-order text-right h-32 w-80">
