    ...
    <div>
      ...
      <div className="flex "> 
        ...
        <div className='hidden sm:block'>
            ...
            <div className="text-center text-3xl pl-10"><Link to="/payment"> 2.  ALERT-INDIA Association for Leprosy education, Rehabilitation & Treatment India </Link></div>
            <div className="text-center text-3xl pl-10"><Link to="/payment">  3.  Annamrita-ISKCON Food Relief Foundation</Link></div>
            <div className="text-center text-3xl pl-10"><Link to="/payment"> 4.  Antarang Foundation  </Link></div>
            <div className="text-center text-3xl pl-10"><Link to="/payment"> 5.  Ashadeep Association </Link></div>
