  ...
  return (
    <div>
        ...
        <Avatar/>
          ...
          <div className="py-15 ">
          <button className="h-1/3 shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover " style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
