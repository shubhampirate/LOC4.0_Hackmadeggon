  ...
  return (
    <div>
        ...
        <div  className="flex ">
          ...
          <button className="h-screen shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover " style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
