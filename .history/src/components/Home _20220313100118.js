  ...
  return (
    ...
    <div className="flex ">
     ...
     <div className='grid grid-cols-1 sm:grid-cols-2 h-auto w-full'>
        ...
        <Link to='/Signin'>
          <button className="text-2xl w-28  py-2 pl-2 mt-8 bg-cyan-500 hover:bg-cyan-700 hover:text-white relative text-white rounded-lg text-opacity-10"> USER </button>
        </Link></div>
        </div>
        </div>
