...
function signin() {
    return (
    <div>
      <div className="relative w-full h-screen bg-gray-100"  style={{backgroundImage: "url(https://www.hdnicewallpapers.com/Walls/Big/Abstract/Natural_Sea_Abstract_5K_Blur_Wallpaper.jpg)"}}>
