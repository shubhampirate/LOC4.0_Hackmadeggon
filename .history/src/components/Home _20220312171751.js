...
function Home () {
  return (
    ...
    <div className="flex justify-center">
     ...
     <div className="bg-no-repeat bg-cover bg-right-top " style={{backgroundImage:"url(https://ak.picdn.net/offset/photos/598dbbd017fb156e48068e52/medium/offset_601742.jpg)"}}></div>
     </div>
  )
}
