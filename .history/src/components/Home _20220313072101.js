...
function Home () {
  return (
    ...
    <div className="flex ">
     ...
     </div><button className="text-2xl w-28 py-2 pl-2 mt-1  mb-5 bg-black hover:bg-gray-600 hover:text-white relative text-white rounded-lg text-opacity-10 "><Link to="/signup">Ngo Signup</Link></button>
     </div>
     </div>
