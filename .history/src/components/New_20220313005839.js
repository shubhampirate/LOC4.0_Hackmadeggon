  ...
  return (
    <div>
        ...
        <div  className="flex   ">
          ...
          <button className="h-screen w-full shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover pt-0" style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
