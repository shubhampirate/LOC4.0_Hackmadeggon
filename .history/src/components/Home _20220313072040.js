...
function Home () {
  return (
    ...
    <div className="flex ">
     ...
     <button className=" text-2xl w-28 py-2 mt-2  mb-3 bg-black hover:bg-gray-600 hover:text-white relative text-white rounded-lg text-opacity-10"><Link to="/signin">User Signin </Link></button>
