  ...
  return (
    <div>
      ...
      <div className="bg-white relative w-full height-7xl flex">
        ...
        <Link to="/bookingslot"><button className="h-72 w-72 p-20 m-2  text-7xl text-indigo-100 transition-colors duration-150 bg-orange-400 rounded-lg focus:shadow-outline hover:bg-cyan-500"> Seminars</button>
       </Link>     
