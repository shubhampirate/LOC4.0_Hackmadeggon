    ...
    <div>
      ...
      <div className="bg-white relative w-full height-7xl flex">
        ...
        <div className='hidden sm:block'><br /><br /><br />
            <button className="h-72 w-full px-6 m-2 text-lg text-indigo-100 transition-colors duration-150 bg-indigo-700 rounded-lg focus:shadow-outline hover:bg-indigo-800"> Seminars</button>
