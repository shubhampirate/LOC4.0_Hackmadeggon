    ...
    <div>
      ...
      <div className="flex "> 
        ...
        <div className='hidden sm:block'>
            <h1 className="text-5xl text-left">NGO </h1>
            <div className="text-center text-3xl"><Link to="/payment">Akshara Centre </Link></div>
            <div className="text-center text-3xl"><Link to="/payment"> ALERT-INDIA Association for Leprosy education, Rehabilitation & Treatment India </Link></div>
            <div className="text-center text-3xl"><Link to="/payment">  Annamrita-ISKCON Food Relief Foundation</Link></div>
            <div className="text-center text-3xl"><Link to="/payment"> Antarang Foundation  </Link></div>
            <div className="text-center text-3xl"><Link to="/payment"> Ashadeep Association </Link></div>
