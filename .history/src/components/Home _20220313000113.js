...
function Home () {
  return (
    ...
    <div className="flex justify-center ">
        ...
        <div className="justify-between pl-20 text-5xl hidden sm:block"> ABOUT </div>
        <div className="justify-items-center pl-10 pr-10 text-5xl hidden sm:block">FUNDS</div>
        <div className="text-5xl hidden pr-10sm:block">BLOG</div>
          <img src={logo}/>
     </div>
     <div className="flex ">
     <button className="pr-10 text-2xl"><Link to="/signin">Signin </Link></button>
     <button className=" pl-10 pr-10 text-2xl"><Link to="/signup"> Signup</Link></button>
     </div>
     </div>
