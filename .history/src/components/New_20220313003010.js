  ...
  return (
    <div>
        ...
        <Avatar />
          ...
          <div className="pt-12 ">
        <div  className="flex">We are here to help You give the society a chance to smile
          <div className="flex "><Link className="hover:text-black" to="/listofngo">
            We are here to help You give the society a chance to smile
          <button className="h-96 shadow-lg hover:shadow-slate-300 bg-no-repeat bg-cover " style={{backgroundImage: "url(https://i.cdn-sc.com/MediaVaultImages/94_thumbnail.jpg)"}} >
