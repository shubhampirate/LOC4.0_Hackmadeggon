  ...
  return (
    <div>
      ...
      <div className="bg-white relative w-full height-7xl flex">
        ...
        <Link to="/bookingslot"><button className="h-72 w-fit px-6 m-2 text-lg text-indigo-100 transition-colors duration-150 bg-indigo-700 rounded-lg focus:shadow-outline hover:bg-indigo-800"> Seminars</button>
       </Link>     <button className=""> WorkShop</button>
                    </div>
        </div>
