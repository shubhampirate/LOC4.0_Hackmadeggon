    ...
    <div className="flex ">
     ...
     <div className='grid grid-cols-1 sm:grid-cols-2 h-auto w-full'>
        <div className='rounded-lg hidden sm:block'>
            <img className='w-full h-full object-cover rounded-3xl' src="https://acumen.org/wp-content/uploads/US-AID-Photo-1600x1100.jpg" alt="" />
        </div>

        <div className='bg-lime-200 flex flex-col justify-center rounded-3xl'>
          <h1 className='text-8xl pl-5 text-left italic'>Habitat </h1>
          <h1 className='text-8xl text-center pr-20 italic'>For </h1>
          <h1 className='text-8xl text-right pr-3 italic'>Humanity </h1>
          <div className="flex justify-center">
        <Link to='/ngosignin'> <button className="text-2xl w-28 py-2 pl-2 mt-8 bg-violet-600 hover:bg-gray-600 hover:text-white relative text-white rounded-lg text-opacity-10"> NGO </button>
        </Link>       <div className="pl-5">
        <Link to='/Signin'>
          <button className="text-2xl w-28  py-2 pl-2 mt-8 bg-cyan-700 hover:bg-cyan-500 hover:text-white relative text-white rounded-lg text-opacity-10"> USER </button>
        </Link></div>
        </div>
        </div>
...
To make nonprofit organisations sustainable and help grow their reach to donors as wells as beneficiaries.</p>
    ...
    <div className='bg-black text-white text-2xl'>
      ...
      <h1 className='text-4xl italic'>About Us</h1>
      <br/>
