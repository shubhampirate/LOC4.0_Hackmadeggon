  ...
  return (
    <div>
      ...
      <div className="h-15"><img classname="h-10" src={logo}/></div>
        ...
        <div className="flex">
      <div className="bg-white relative w-full height-8xl flex">
        <div className="pl-5">
        <div className='grid grid-cols-1 sm:grid-cols-2 h-auto w-full'>
        <div className='flex sm:block'>
        <Link to="/bookingslot"><button className="h-72 w-max p-20 m-2  text-8xl text-indigo-100 transition-colors duration-150 bg-orange-400 rounded-lg focus:shadow-outline hover:bg-cyan-500"> Seminars</button>
       </Link>     
       <button className="h-72 w-fit p-20 m-2  text-8xl text-indigo-100 transition-colors duration-150 bg-orange-400 rounded-lg focus:shadow-outline hover:bg-cyan-500"> Workshop</button>
                    </div>
        </div>
